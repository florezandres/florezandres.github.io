...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-NJXFHP7J.js").then((m) => m.Home)
  },
  {
    path: "bootup",
    loadComponent: () => import("./chunk-I6XIOVVJ.js").then((m) => m.LoadingScreen)
  }
];
...
var Header = class _Header {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Header, selectors: [["app-header"]], decls: 1, vars: 0, consts: [["hidden", ""]], template: function Header_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElement(0, "header", 0);
    }
  }, styles: ['\n\n#header[_ngcontent-%COMP%] {\n  width: 100vw;\n  height: 80px;\n  margin-bottom: 20px;\n}\n.window[_ngcontent-%COMP%] {\n  font:\n    9pt "Segoe UI",\n    "SegoeUI",\n    "Noto Sans",\n    sans-serif;\n  box-shadow: 2px 2px 10px 1px rgba(0, 0, 0, 0.7), inset 0 0 0 1px rgba(255, 255, 255, 1);\n  border: 1px solid rgba(0, 0, 0, 0.7);\n  border-radius: 6px;\n  position: relative;\n  z-index: 0;\n}\n.window[_ngcontent-%COMP%]::before {\n  content: "";\n  position: absolute;\n  z-index: -1;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  border-radius: 6px;\n  background:\n    linear-gradient(\n      transparent 20%,\n      rgba(255, 255, 255, 0.7) 40%,\n      transparent 41%),\n    linear-gradient(\n      to right,\n      rgba(255, 255, 255, 0.4),\n      rgba(0, 0, 0, 0.1),\n      rgba(255, 255, 255, 0.2)),\n    #4580c4;\n  background-color: #4580c4;\n  box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.99);\n}\n.window.glass[_ngcontent-%COMP%]::before {\n  opacity: 0.6;\n}\n.window.glass[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  z-index: -10;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  border-radius: 6px;\n  border: none;\n  -webkit-backdrop-filter: blur(4px);\n  backdrop-filter: blur(4px);\n}\n.title-bar[_ngcontent-%COMP%] {\n  font:\n    9pt "Segoe UI",\n    "SegoeUI",\n    "Noto Sans",\n    sans-serif;\n  box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.6);\n  border: 1px solid rgba(0, 0, 0, 0.7);\n  border-radius: 6px 6px 0 0;\n  padding: 6px;\n  padding-top: 0;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background:\n    linear-gradient(\n      to right,\n      rgba(255, 255, 255, 0.4),\n      rgba(0, 0, 0, 0.1),\n      rgba(255, 255, 255, 0.2)),\n    #4580c4;\n  background-color: #4580c4;\n}\n.title-bar-text[_ngcontent-%COMP%] {\n  color: #000;\n  letter-spacing: 0;\n  line-height: 15px;\n  padding-top: 6px;\n  text-shadow:\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff;\n}\n.title-bar-controls[_ngcontent-%COMP%] {\n  display: flex;\n  background: rgba(255, 255, 255, 0.19);\n  border: 1px solid rgba(0, 0, 0, 0.3);\n  border-top: 0;\n  border-radius: 0 0 5px 5px;\n  box-shadow:\n    0 1px 0 rgba(255, 255, 255, 0.98),\n    1px 0 0 rgba(255, 255, 255, 0.98),\n    -1px 0 0 rgba(255, 255, 255, 0.98);\n}\nheader[_ngcontent-%COMP%] {\n  width: 100vw;\n  height: 3rem;\n  background-image:\n    linear-gradient(\n      135deg,\n      #fff5 70px,\n      transparent 100px),\n    linear-gradient(\n      225deg,\n      #fff5 70px,\n      transparent 100px),\n    linear-gradient(\n      54deg,\n      #0002 0 4%,\n      #6661 6% 6%,\n      #0002 8% 10%,\n      #0002 15% 16%,\n      #aaa1 17% 18%,\n      #0002 23% 24%,\n      #bbb2 25% 26%,\n      #0002 31% 33%,\n      #0002 34% 34.5%,\n      #bbb2 36% 40%,\n      #0002 41% 41.5%,\n      #bbb2 44% 45%,\n      #bbb2 46% 47%,\n      #0002 48% 49%,\n      #0002 50% 50.5%,\n      #0002 56% 56.5%,\n      #bbb2 57% 63%,\n      #0002 67% 69%,\n      rgba(187, 187, 187, 0) 69.5% 70%,\n      rgba(0, 0, 0, 0) 73.5% 74%,\n      #bbb2 74.5% 79%,\n      #0002 80% 84%,\n      #aaa2 85% 86%,\n      #0002 87%,\n      #bbb1 90%);\n  background-size:\n    auto,\n    auto,\n    100vw 100vh;\n  background-attachment: fixed;\n  border: none;\n  position: absolute;\n  border-bottom: 0.8px solid rgba(0, 0, 0, 0.671);\n  background-color: #3e83a380;\n  box-shadow: 2px 2px 5px 2px rgba(0, 0, 0, 0.40);\n  box-shadow: 2px 2px 10px 1px var(--w7-w-bd), inset 0 0 0 1px #fffa;\n}\n/*# sourceMappingURL=header.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Header, [{
    type: Component,
    args: [{ selector: "app-header", imports: [], template: '<!--\n<div id="header" class="window glass active">\n  <div class="title-bar">\n    <div class="title-bar-text">A complete window</div>\n    <div class="title-bar-controls">\n      <button aria-label="Help"></button>\n      <button aria-label="Minimize"></button>\n      <button aria-label="Maximize" disabled></button>\n      <button aria-label="Close"></button>\n    </div>\n  </div>\n</div> -->\n<header hidden>\n</header>\n\n', styles: ['/* src/app/layout/header/header.css */\n#header {\n  width: 100vw;\n  height: 80px;\n  margin-bottom: 20px;\n}\n.window {\n  font:\n    9pt "Segoe UI",\n    "SegoeUI",\n    "Noto Sans",\n    sans-serif;\n  box-shadow: 2px 2px 10px 1px rgba(0, 0, 0, 0.7), inset 0 0 0 1px rgba(255, 255, 255, 1);\n  border: 1px solid rgba(0, 0, 0, 0.7);\n  border-radius: 6px;\n  position: relative;\n  z-index: 0;\n}\n.window::before {\n  content: "";\n  position: absolute;\n  z-index: -1;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  border-radius: 6px;\n  background:\n    linear-gradient(\n      transparent 20%,\n      rgba(255, 255, 255, 0.7) 40%,\n      transparent 41%),\n    linear-gradient(\n      to right,\n      rgba(255, 255, 255, 0.4),\n      rgba(0, 0, 0, 0.1),\n      rgba(255, 255, 255, 0.2)),\n    #4580c4;\n  background-color: #4580c4;\n  box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.99);\n}\n.window.glass::before {\n  opacity: 0.6;\n}\n.window.glass::after {\n  content: "";\n  position: absolute;\n  z-index: -10;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  border-radius: 6px;\n  border: none;\n  -webkit-backdrop-filter: blur(4px);\n  backdrop-filter: blur(4px);\n}\n.title-bar {\n  font:\n    9pt "Segoe UI",\n    "SegoeUI",\n    "Noto Sans",\n    sans-serif;\n  box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.6);\n  border: 1px solid rgba(0, 0, 0, 0.7);\n  border-radius: 6px 6px 0 0;\n  padding: 6px;\n  padding-top: 0;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background:\n    linear-gradient(\n      to right,\n      rgba(255, 255, 255, 0.4),\n      rgba(0, 0, 0, 0.1),\n      rgba(255, 255, 255, 0.2)),\n    #4580c4;\n  background-color: #4580c4;\n}\n.title-bar-text {\n  color: #000;\n  letter-spacing: 0;\n  line-height: 15px;\n  padding-top: 6px;\n  text-shadow:\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff,\n    0 0 10px #fff;\n}\n.title-bar-controls {\n  display: flex;\n  background: rgba(255, 255, 255, 0.19);\n  border: 1px solid rgba(0, 0, 0, 0.3);\n  border-top: 0;\n  border-radius: 0 0 5px 5px;\n  box-shadow:\n    0 1px 0 rgba(255, 255, 255, 0.98),\n    1px 0 0 rgba(255, 255, 255, 0.98),\n    -1px 0 0 rgba(255, 255, 255, 0.98);\n}\nheader {\n  width: 100vw;\n  height: 3rem;\n  background-image:\n    linear-gradient(\n      135deg,\n      #fff5 70px,\n      transparent 100px),\n    linear-gradient(\n      225deg,\n      #fff5 70px,\n      transparent 100px),\n    linear-gradient(\n      54deg,\n      #0002 0 4%,\n      #6661 6% 6%,\n      #0002 8% 10%,\n      #0002 15% 16%,\n      #aaa1 17% 18%,\n      #0002 23% 24%,\n      #bbb2 25% 26%,\n      #0002 31% 33%,\n      #0002 34% 34.5%,\n      #bbb2 36% 40%,\n      #0002 41% 41.5%,\n      #bbb2 44% 45%,\n      #bbb2 46% 47%,\n      #0002 48% 49%,\n      #0002 50% 50.5%,\n      #0002 56% 56.5%,\n      #bbb2 57% 63%,\n      #0002 67% 69%,\n      rgba(187, 187, 187, 0) 69.5% 70%,\n      rgba(0, 0, 0, 0) 73.5% 74%,\n      #bbb2 74.5% 79%,\n      #0002 80% 84%,\n      #aaa2 85% 86%,\n      #0002 87%,\n      #bbb1 90%);\n  background-size:\n    auto,\n    auto,\n    100vw 100vh;\n  background-attachment: fixed;\n  border: none;\n  position: absolute;\n  border-bottom: 0.8px solid rgba(0, 0, 0, 0.671);\n  background-color: #3e83a380;\n  box-shadow: 2px 2px 5px 2px rgba(0, 0, 0, 0.40);\n  box-shadow: 2px 2px 10px 1px var(--w7-w-bd), inset 0 0 0 1px #fffa;\n}\n/*# sourceMappingURL=header.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Header, { className: "Header", filePath: "src/app/layout/header/header.ts", lineNumber: 9 });
})();
...
var Footer = class _Footer {
      ...
      setTimeout(() => {
        const onAnimEnd = (e) => {
          if (e.animationName === "slideDown") {
            ...
            languagetooltip.removeEventListener("animationend", onAnimEnd);
          }
        };
        languagetooltip.addEventListener("animationend", onAnimEnd);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Footer, selectors: [["app-footer"]], decls: 44, vars: 1, consts: [["id", "footer-image", "src", "assets/images/windows-vista.webp", "alt", "Footer Image", 3, "click"], [1, "taskbar-icons"], [1, "hora"], ["id", "hora"], [1, "theme"], ["hidden", "", "href", ""], [1, "sound"], ["id", "sound-icon", "src", "assets/icons/sound.ico", "alt", "Sound Icon"], [1, "network"], ["id", "network-icon", "src", "assets/images/network.webp", "alt", "Network Icon"], [1, "language"], ["id", "language", 3, "click"], ["id", "taskbar-menu", 1, "taskbar-menu"], [1, "left"], [1, "left-links"], ["href", "#info-about"], ["src", "/assets/images/about.webp", "alt", ""], ["href", "#dialog-resume"], ["src", "/assets/images/resume.webp", "alt", ""], ["href", "#info-skills"], ["src", "/assets/images/skills.webp", "alt", ""], ["href", "#info-projects"], ["src", "/assets/images/projects.webp", "alt", ""], ["href", "#info-contact"], ["src", "/assets/images/contact.webp", "alt", ""], [1, "search"], ["type", "text", "placeholder", "Type here to search..."], [1, "right"], [1, "taskbar-pfp"], ["src", "assets/images/role.png", "alt", "Profile Picture"], [1, "language-options"], ["id", "language-en", 1, "language-option", 3, "click"], ["id", "language-es", 1, "language-option", 3, "click"]], template: function Footer_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElementStart(0, "footer")(1, "img", 0);
      \u0275\u0275domListener("click", function Footer_Template_img_click_1_listener() {
        return ctx.onFooterImageClick();
      });
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(2, "div", 1)(3, "div", 2)(4, "span", 3);
      \u0275\u0275text(5);
      \u0275\u0275domElementEnd()();
      ...
      \u0275\u0275domElement(12, "img", 9);
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(13, "div", 10)(14, "span", 11);
      \u0275\u0275domListener("click", function Footer_Template_span_click_14_listener() {
        return ctx.onLanguageIconClick();
      });
      \u0275\u0275text(15, "EN");
      \u0275\u0275domElementEnd()()()();
      \u0275\u0275domElementStart(16, "div", 12)(17, "div", 13)(18, "div", 14)(19, "a", 15);
      \u0275\u0275domElement(20, "img", 16);
      \u0275\u0275text(21, " About");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(22, "a", 17);
      \u0275\u0275domElement(23, "img", 18);
      \u0275\u0275text(24, " Resume");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(25, "a", 19);
      \u0275\u0275domElement(26, "img", 20);
      \u0275\u0275text(27, " Skills");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(28, "a", 21);
      \u0275\u0275domElement(29, "img", 22);
      \u0275\u0275text(30, " Projects");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(31, "a", 23);
      \u0275\u0275domElement(32, "img", 24);
      \u0275\u0275text(33, " Contact");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(34, "div", 25);
      \u0275\u0275domElement(35, "input", 26);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(36, "div", 27)(37, "div", 28);
      \u0275\u0275domElement(38, "img", 29);
      \u0275\u0275domElementEnd()()();
      \u0275\u0275domElementStart(39, "div", 30)(40, "button", 31);
      \u0275\u0275domListener("click", function Footer_Template_button_click_40_listener() {
        return ctx.changeLanguage("EN");
      });
      \u0275\u0275text(41, "EN");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(42, "button", 32);
      \u0275\u0275domListener("click", function Footer_Template_button_click_42_listener() {
    ...
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", (ctx.currentTime.getHours() % 12 === 0 ? 12 : ctx.currentTime.getHours() % 12) + ":" + (ctx.currentTime.getMinutes() < 10 ? "0" + ctx.currentTime.getMinutes() : ctx.currentTime.getMinutes()) + " " + (ctx.currentTime.getHours() >= 12 ? "PM" : "AM"), " ");
    }
  }, styles: ['\n\nfooter[_ngcontent-%COMP%] {\n  height: 1.8rem;\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  background-image:\n    linear-gradient(\n      180deg,\n      rgba(255, 255, 255, 0.40) 40%,\n      transparent 20px);\n  background-color: rgba(8, 13, 17, 0.6);\n  -webkit-backdrop-filter: blur(10px);\n  backdrop-filter: blur(10px);\n  font-size: 0.75em;\n  z-index: 1000;\n  border-top: 0.5px solid rgba(43, 43, 43, 0.5);\n}\n#footer-image[_ngcontent-%COMP%] {\n  height: 120%;\n  transform: translateY(-10%);\n  position: absolute;\n  left: 0.5%;\n  border: 1px solid rgba(0, 0, 0, 0.5);\n  border-radius: 50%;\n  transition: box-shadow 0.3s ease-in-out;\n}\n#footer-image[_ngcontent-%COMP%]:hover {\n  cursor: pointer;\n}\n#footer-image[_ngcontent-%COMP%]:hover {\n  box-shadow: 0 0 3px rgba(255, 255, 255, 0.4);\n  transition: box-shadow 0.3s ease-in-out;\n}\n#hora[_ngcontent-%COMP%] {\n  position: absolute;\n  right: 1rem;\n  top: 50%;\n  transform: translateY(-50%);\n  font-family: "Alvera Regular Circle";\n  color: #fff;\n  text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7);\n}\n.network[_ngcontent-%COMP%], \n.sound[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  display: flex;\n  gap: 10px;\n}\n.network[_ngcontent-%COMP%] {\n  right: 5rem;\n}\n.sound[_ngcontent-%COMP%] {\n  right: 6.5rem;\n}\n#language[_ngcontent-%COMP%] {\n  position: absolute;\n  right: 8.25rem;\n  top: 50%;\n  transform: translateY(-50%);\n  font-family: Doto, times;\n  font-variation-settings: "wght" 900, "ROND" 100;\n  color: #fff;\n  text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7);\n}\n#language[_ngcontent-%COMP%]:hover {\n  cursor: pointer;\n  text-decoration: underline;\n}\n.network[_ngcontent-%COMP%]   img[_ngcontent-%COMP%], \n.sound[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  height: 17px;\n  filter: drop-shadow(0 0 1px rgba(0, 0, 0, 0.8));\n  cursor: pointer;\n}\n#taskbar-menu[_ngcontent-%COMP%] {\n  display: none;\n  padding: 0.4rem;\n  position: absolute;\n  bottom: 1.8rem;\n  left: 0;\n  background-image:\n    linear-gradient(\n      180deg,\n      #fff5 5px,\n      transparent 20px);\n  background-color: rgba(8, 13, 17, 0.6);\n  height: 20rem;\n  z-index: 999;\n  width: 18rem;\n  -webkit-backdrop-filter: blur(8px);\n  backdrop-filter: blur(8px);\n  border: 1px solid rgba(0, 0, 0, 0.5);\n  border-radius: var(--border-radius) var(--border-radius) 0 0;\n  box-shadow: 2px 2px 7px 1px var(--w7-w-bd), inset 0 0 0 1px rgba(202, 202, 202, 0.5);\n  border: 0.8px solid rgba(0, 0, 0, 0.671);\n  animation: _ngcontent-%COMP%_slideUp 0.15s ease-out;\n}\n.taskabar-menu-content[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  height: 100%;\n  margin: 0.3rem;\n}\n.left[_ngcontent-%COMP%] {\n  width: 60%;\n}\n.left-links[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0rem;\n  padding: 0.5rem;\n  background-color: rgba(255, 255, 255);\n  border-radius: var(--internal-border-radius);\n  height: 85%;\n}\n.left-links[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  font-family: doto, times;\n  font-variation-settings: "wght" 800, "ROND" 100;\n  color: #000;\n  text-decoration: none;\n  padding: 0.3rem;\n  margin: 0;\n  border-radius: var(--internal-border-radius);\n  transition: background-color 0.3s ease-in-out, color 0.3s ease-in-out;\n}\n.left-links[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  height: 25px;\n  width: auto;\n  margin-right: 0.25rem;\n  vertical-align: middle;\n}\n.left-links[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n  background-color: rgba(0, 0, 0, 0.1);\n  color: #0059ff;\n  transition: background-color 0.3s ease-in-out, color 0.3s ease-in-out;\n}\n.search[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n  padding: 0.3rem;\n  margin-top: 0.4rem;\n  width: 100%;\n  margin-bottom: 0.4rem;\n}\n.right[_ngcontent-%COMP%] {\n  width: 40%;\n}\n.taskbar-pfp[_ngcontent-%COMP%] {\n  margin: 0 auto;\n  position: absolute;\n  top: 0;\n  transform: translate(40%, -50%);\n}\n.taskbar-pfp[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  margin: 0 auto;\n  align-self: center;\n  height: 70px;\n  width: auto;\n}\n.theme[_ngcontent-%COMP%] {\n  position: absolute;\n  right: 10.25rem;\n  top: 50%;\n  transform: translateY(-50%);\n  font-family: Doto, times;\n  font-variation-settings: "wght" 900, "ROND" 100;\n  color: #fff;\n  text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7);\n}\n.theme[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: inherit;\n  text-decoration: none;\n}\n#language-tooltip[_ngcontent-%COMP%] {\n  color: #000000;\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  bottom: 2.5rem;\n  right: 7.8rem;\n  background-color: rgba(0, 0, 0, 0.8);\n  padding: 0.5rem;\n  border-radius: 5px;\n  z-index: 10000;\n  font-size: 0.75em;\n  display: none;\n  pointer-events: none;\n  max-width: 140px;\n  box-sizing: border-box;\n  margin: 0;\n}\n#language-tooltip[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  text-align: left;\n  font-family: Doto, times;\n  font-variation-settings: "wght" 900, "ROND" 100;\n}\n#language-tooltip.visible[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  animation: _ngcontent-%COMP%_slideUp 0.9s ease-out;\n  animation-fill-mode: forwards;\n  pointer-events: auto;\n}\n#language-tooltip.hiding[_ngcontent-%COMP%] {\n  z-index: 998;\n  animation: _ngcontent-%COMP%_slideDown 0.5s ease-out;\n  animation-fill-mode: forwards;\n  pointer-events: none;\n}\n.language-options[_ngcontent-%COMP%] {\n  position: fixed;\n  bottom: 2.5rem;\n  right: 8rem;\n  display: none;\n  gap: 0.5rem;\n  z-index: 10000;\n  display: none;\n}\n@keyframes _ngcontent-%COMP%_slideUp {\n  from {\n    transform: translateY(40%);\n    opacity: 0;\n  }\n  to {\n    transform: translateY(0);\n    opacity: 1;\n  }\n}\n@keyframes _ngcontent-%COMP%_slideDown {\n  from {\n    transform: translateY(0);\n    opacity: 1;\n  }\n  to {\n    transform: translateY(100%);\n    opacity: 0;\n  }\n}\n/*# sourceMappingURL=footer.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Footer, [{
    type: Component,
    args: [{ selector: "app-footer", imports: [], template: `<footer>
    <img id="footer-image" src="assets/images/windows-vista.webp" alt="Footer Image" (click)="onFooterImageClick()">
    <div class="taskbar-icons">
        <div class="hora">
        <span id="hora">
            {{ (currentTime.getHours() % 12 === 0 ? 12 : currentTime.getHours() % 12) + ':' + (currentTime.getMinutes() < 10 ? ('0' + currentTime.getMinutes()) : currentTime.getMinutes()) + ' ' + (currentTime.getHours() >= 12 ? 'PM' : 'AM') }}
        </span>
        </div>
        <div class="theme">
            <a hidden href="">
        ...
        <div class="sound">
            <img id="sound-icon" src="assets/icons/sound.ico" alt="Sound Icon">
        </div>
        <div class="network">
            <img id="network-icon" src="assets/images/network.webp" alt="Network Icon">
        </div>
        <div class="language">
            <span (click)="onLanguageIconClick()" id="language">EN</span>
        </div>
    </div>

</footer>

<div id="taskbar-menu" class="taskbar-menu">
        <div class="left">
            <div class="left-links">
                <a href="#info-about"><img src="/assets/images/about.webp" alt=""> About</a>
                <a href="#dialog-resume"><img src="/assets/images/resume.webp" alt=""> Resume</a>
                <a href="#info-skills"><img src="/assets/images/skills.webp" alt=""> Skills</a>
                <a href="#info-projects"><img src="/assets/images/projects.webp" alt=""> Projects</a>
                <a href="#info-contact"><img src="/assets/images/contact.webp" alt=""> Contact</a>
            </div>
            <div class="search">
        ...
        <div class="right">
            <div class="taskbar-pfp">
                <img src="assets/images/role.png" alt="Profile Picture">
            </div>
        </div>
</div>
<!--
<div id="language-tooltip" role="tooltip" class="is-top is-left">
    <p>Change Language</p>
...
<div class="language-options">
    <button id="language-en" class="language-option" (click)="changeLanguage('EN')">EN</button>
    <button id="language-es" class="language-option" (click)="changeLanguage('ES')">ES</button>
</div>`, styles: ['/* src/app/layout/footer/footer.css */\nfooter {\n  height: 1.8rem;\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  background-image:\n    linear-gradient(\n      180deg,\n      rgba(255, 255, 255, 0.40) 40%,\n      transparent 20px);\n  background-color: rgba(8, 13, 17, 0.6);\n  -webkit-backdrop-filter: blur(10px);\n  backdrop-filter: blur(10px);\n  font-size: 0.75em;\n  z-index: 1000;\n  border-top: 0.5px solid rgba(43, 43, 43, 0.5);\n}\n#footer-image {\n  height: 120%;\n  transform: translateY(-10%);\n  position: absolute;\n  left: 0.5%;\n  border: 1px solid rgba(0, 0, 0, 0.5);\n  border-radius: 50%;\n  transition: box-shadow 0.3s ease-in-out;\n}\n#footer-image:hover {\n  cursor: pointer;\n}\n#footer-image:hover {\n  box-shadow: 0 0 3px rgba(255, 255, 255, 0.4);\n  transition: box-shadow 0.3s ease-in-out;\n}\n#hora {\n  position: absolute;\n  right: 1rem;\n  top: 50%;\n  transform: translateY(-50%);\n  font-family: "Alvera Regular Circle";\n  color: #fff;\n  text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7);\n}\n.network,\n.sound {\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  display: flex;\n  gap: 10px;\n}\n.network {\n  right: 5rem;\n}\n.sound {\n  right: 6.5rem;\n}\n#language {\n  position: absolute;\n  right: 8.25rem;\n  top: 50%;\n  transform: translateY(-50%);\n  font-family: Doto, times;\n  font-variation-settings: "wght" 900, "ROND" 100;\n  color: #fff;\n  text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7);\n}\n#language:hover {\n  cursor: pointer;\n  text-decoration: underline;\n}\n.network img,\n.sound img {\n  height: 17px;\n  filter: drop-shadow(0 0 1px rgba(0, 0, 0, 0.8));\n  cursor: pointer;\n}\n#taskbar-menu {\n  display: none;\n  padding: 0.4rem;\n  position: absolute;\n  bottom: 1.8rem;\n  left: 0;\n  background-image:\n    linear-gradient(\n      180deg,\n      #fff5 5px,\n      transparent 20px);\n  background-color: rgba(8, 13, 17, 0.6);\n  height: 20rem;\n  z-index: 999;\n  width: 18rem;\n  -webkit-backdrop-filter: blur(8px);\n  backdrop-filter: blur(8px);\n  border: 1px solid rgba(0, 0, 0, 0.5);\n  border-radius: var(--border-radius) var(--border-radius) 0 0;\n  box-shadow: 2px 2px 7px 1px var(--w7-w-bd), inset 0 0 0 1px rgba(202, 202, 202, 0.5);\n  border: 0.8px solid rgba(0, 0, 0, 0.671);\n  animation: slideUp 0.15s ease-out;\n}\n.taskabar-menu-content {\n  display: flex;\n  flex-direction: row;\n  height: 100%;\n  margin: 0.3rem;\n}\n.left {\n  width: 60%;\n}\n.left-links {\n  display: flex;\n  flex-direction: column;\n  gap: 0rem;\n  padding: 0.5rem;\n  background-color: rgba(255, 255, 255);\n  border-radius: var(--internal-border-radius);\n  height: 85%;\n}\n.left-links a {\n  font-family: doto, times;\n  font-variation-settings: "wght" 800, "ROND" 100;\n  color: #000;\n  text-decoration: none;\n  padding: 0.3rem;\n  margin: 0;\n  border-radius: var(--internal-border-radius);\n  transition: background-color 0.3s ease-in-out, color 0.3s ease-in-out;\n}\n.left-links img {\n  height: 25px;\n  width: auto;\n  margin-right: 0.25rem;\n  vertical-align: middle;\n}\n.left-links a:hover {\n  background-color: rgba(0, 0, 0, 0.1);\n  color: #0059ff;\n  transition: background-color 0.3s ease-in-out, color 0.3s ease-in-out;\n}\n.search input {\n  padding: 0.3rem;\n  margin-top: 0.4rem;\n  width: 100%;\n  margin-bottom: 0.4rem;\n}\n.right {\n  width: 40%;\n}\n.taskbar-pfp {\n  margin: 0 auto;\n  position: absolute;\n  top: 0;\n  transform: translate(40%, -50%);\n}\n.taskbar-pfp img {\n  margin: 0 auto;\n  align-self: center;\n  height: 70px;\n  width: auto;\n}\n.theme {\n  position: absolute;\n  right: 10.25rem;\n  top: 50%;\n  transform: translateY(-50%);\n  font-family: Doto, times;\n  font-variation-settings: "wght" 900, "ROND" 100;\n  color: #fff;\n  text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.7);\n}\n.theme a {\n  color: inherit;\n  text-decoration: none;\n}\n#language-tooltip {\n  color: #000000;\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  bottom: 2.5rem;\n  right: 7.8rem;\n  background-color: rgba(0, 0, 0, 0.8);\n  padding: 0.5rem;\n  border-radius: 5px;\n  z-index: 10000;\n  font-size: 0.75em;\n  display: none;\n  pointer-events: none;\n  max-width: 140px;\n  box-sizing: border-box;\n  margin: 0;\n}\n#language-tooltip p {\n  margin: 0;\n  text-align: left;\n  font-family: Doto, times;\n  font-variation-settings: "wght" 900, "ROND" 100;\n}\n#language-tooltip.visible {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  animation: slideUp 0.9s ease-out;\n  animation-fill-mode: forwards;\n  pointer-events: auto;\n}\n#language-tooltip.hiding {\n  z-index: 998;\n  animation: slideDown 0.5s ease-out;\n  animation-fill-mode: forwards;\n  pointer-events: none;\n}\n.language-options {\n  position: fixed;\n  bottom: 2.5rem;\n  right: 8rem;\n  display: none;\n  gap: 0.5rem;\n  z-index: 10000;\n  display: none;\n}\n@keyframes slideUp {\n  from {\n    transform: translateY(40%);\n    opacity: 0;\n  }\n  to {\n    transform: translateY(0);\n    opacity: 1;\n  }\n}\n@keyframes slideDown {\n  from {\n    transform: translateY(0);\n    opacity: 1;\n  }\n  to {\n    transform: translateY(100%);\n    opacity: 0;\n  }\n}\n/*# sourceMappingURL=footer.css.map */\n'] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Footer, { className: "Footer", filePath: "src/app/layout/footer/footer.ts", lineNumber: 9 });
})();
...
var App = class _App {
  router;
  title = signal("florezandres.github.io", ...ngDevMode ? [{ debugName: "title" }] : []);
  showFooter = signal(false, ...ngDevMode ? [{ debugName: "showFooter" }] : []);
  constructor(router) {
    this.router = router;
    setTimeout(() => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 6, vars: 1, consts: [["href", \u0275\u0275trustConstantResourceUrl`https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap`, "rel", "stylesheet"], ["id", "content", 1, "content"]], template: function App_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "link", 0);
      \u0275\u0275elementStart(1, "body");
      \u0275\u0275element(2, "app-header");
      \u0275\u0275elementStart(3, "main", 1);
      \u0275\u0275element(4, "router-outlet");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(5, App_Conditional_5_Template, 1, 0, "app-footer");
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
